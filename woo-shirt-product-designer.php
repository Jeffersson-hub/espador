...
class spdfw_frontend {
	...
	public static function spdfw_before_totals( $cart_object ): void {
	...
	++$nos_icons;
				...
				<div id='view_mode'>
					<div  class="mode">
						...
						<p><?php echo __('Gauche', 'woo-shirt-product-designer'); ?></p>
					</div>
					<div  class="mode">
						<span class="mode_img_wrap">
							<img id="o_back" src="<?php echo $first_designer_variation_back; ?>" width="100%" height="80%" />
						</span>
						<p><?php echo __('Droite', 'woo-shirt-product-designer'); ?></p>
					</div>
				...
				<div class="designer_overview_overlay"></div>
					<div class="designer_overview_inner">
						...
						<b><?php echo __('Base graphic', 'woo-shirt-product-designer'); ?>:</b>
